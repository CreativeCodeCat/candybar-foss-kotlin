...
class ThemeAdapter(
    ...
    override fun getItem(position: Int): Theme {
    ...
    override fun getView(position: Int, view: View?, viewGroup: ViewGroup): View {
        ...
        holder.name.text = themes[position].displayName(context)
        ...
        holder.container.setOnClickListener {
            ...
            val fm = (context as? AppCompatActivity)?.supportFragmentManager ?: return@setOnClickListener
            val fragment = fm.findFragmentByTag(ThemeChooserFragment.TAG)

            if (fragment is ThemeChooserFragment) {
                fragment.setTheme(themes[position])
            }
        }
